CREATE VIEW dbo.vw_x12_820_omap
AS
SELECT     dbo.x12_transaction.st02_transaction_control_no, dbo.x12_transaction.st01_transaction_id_code, dbo.x12_functional_group.gs08_version_id_code, 
                      ...
                      dbo.x12_820_remittance_advice.bpr16_check_eff_date AS check_date, dbo.x12_820_remittance_advice.trn02_trace_number AS check_number, 
                      ...
                      dbo.x12_820_remittance_advice.L2000B_ent04_org_id_code_omap_rate_group, 
                      dbo.x12_820_remittance_advice.L2000B_ent04_org_id_code_omap_perc, dbo.x12_820_remittance_advice.L2000B_ent04_org_id_code_omap_php, 
                      dbo.x12_820_remittance_advice.L2000B_ent04_org_id_code_omap_fips, dbo.x12_820_remittance_advice.L2100B_nm109_individual_id
FROM         dbo.x12_820_remittance_advice INNER JOIN
                      dbo.x12_transaction ON dbo.x12_820_remittance_advice.x12_transaction_id = dbo.x12_transaction.x12_transaction_id INNER JOIN
...
GROUP BY dbo.x12_transaction.st02_transaction_control_no, dbo.x12_transaction.st01_transaction_id_code, dbo.x12_functional_group.gs08_version_id_code, 
                      ...
                      dbo.x12_interchange.isa06_sender_id, dbo.x12_interchange.isa05_sender_id_qual, dbo.x12_interchange.isa04_security_info, 
                      dbo.x12_interchange.isa03_security_info_qual, dbo.x12_interchange.isa02_auth_info, dbo.x12_interchange.isa01_auth_info_qual, 
                      dbo.x12_transaction.x12_transaction_id, dbo.x12_interchange.isa14_ack_requested, dbo.x12_820_remittance_advice.bpr02_total_prov_pmt_amt, 
                      dbo.x12_820_remittance_advice.bpr16_check_eff_date, dbo.x12_820_remittance_advice.trn02_trace_number, 
                      dbo.x12_820_remittance_advice.L1000A_n102_receiver_org_nm, dbo.x12_820_remittance_advice.L1000A_n104_receiver_id, 
                      dbo.x12_820_remittance_advice.L1000B_n102_payer_nm, dbo.x12_820_remittance_advice.L1000B_n103_payer_id, 
                      dbo.x12_820_remittance_advice.L2000B_ent04_org_id_code_omap_rate_group, 
                      dbo.x12_820_remittance_advice.L2000B_ent04_org_id_code_omap_perc, dbo.x12_820_remittance_advice.L2000B_ent04_org_id_code_omap_php, 
                      dbo.x12_820_remittance_advice.L2000B_ent04_org_id_code_omap_fips, dbo.x12_820_remittance_advice.L2100B_nm109_individual_id
