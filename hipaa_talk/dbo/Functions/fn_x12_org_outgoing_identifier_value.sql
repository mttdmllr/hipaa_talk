CREATE FUNCTION [dbo].[fn_x12_org_outgoing_identifier_value] (@x12_organization_id int, @identifier_qual varchar(32))
RETURNS varchar(64) AS  
/*********************
-- START DOC --
FUNCTION: fn_x12_org_outgoing_identifier_value
	...
	Example:	select dbo.fn_x12_org_outgoing_identifier_value(9, 'ZZ') -- Returns an integer of the identifier_value for x12_organization_id = 9 and the ZZ qualifier
-- END DOC --
*********************/
BEGIN
